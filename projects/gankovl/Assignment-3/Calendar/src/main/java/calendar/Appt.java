...
public class Appt{
    ...
    private static final int NO_TIME = -1532;
    //changing this to a more random value
	...
	public void setValid() {
		...
		if (startMonth < 1 || startMonth > 12)
			this.valid = false;
		else if ((startHour < 0 || startHour > 23) && startHour != NO_TIME)
			this.valid = false;
		else if ((startMinute < 0 || startMinute > 59) && startMinute != NO_TIME)
			this.valid = false;
		else if (startYear <= 0)
			this.valid = false;
		else {
